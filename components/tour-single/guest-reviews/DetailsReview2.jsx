        ...
        <div className="row x-gap-20 y-gap-20 items-center">
          <div className="col-auto">
            <img
              width={60}
              height={60}
              src="https://img.freepik.com/free-photo/beautiful-girl-standing-boat-looking-mountains-ratchaprapha-dam-khao-sok-national-park-surat-thani-province-thailand_335224-849.jpg"
              alt="image"
            />
          </div>
          <div className="col-auto">
