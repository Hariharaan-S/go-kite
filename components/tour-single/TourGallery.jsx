              ...
              <div className="relative d-flex justify-center overflow-hidden js-section-slider">
                ...
                >
                  {tour?.slideImg?.map((slide, i) => (
                    <SwiperSlide key={i}>
                    <img src="https://img.freepik.com/free-photo/beautiful-girl-standing-boat-looking-mountains-ratchaprapha-dam-khao-sok-national-park-surat-thani-province-thailand_335224-849.jpg" alt="" />
                    </SwiperSlide>
                  ))}
                </Swiper>
