...
.trip-option input[type="checkbox"] {
  width: 16px;
  height: 16px;
  margin: 0;
  accent-color: #ff6b35;
        ...
        <div className="flight-search-container">
          ...
          <div className="flight-field">
            ...
            <input
              className="flight-input"
              type="text"
              defaultValue="January 11-Wednesday, 2025"
              readOnly
            />
          </div>
          {/* RETURN */}
          <div className="flight-field">
            ...
            <input
              className="flight-input"
              type="text"
              defaultValue="February 12-Monday, 2025"
              readOnly
            />
          </div>
          {/* PASSENGERS */}
          ...
          <div className="trip-options-left">
            ...
            >
              <input
                ...
                onChange={() =>
                  setTripType(
                    tripType === "directFlight" ? "roundTrip" : "directFlight"
                  )
                }
              />
            ...
            >
              <input
                ...
                id="defenceFare"
                name="defenceFare"
                checked={tripType === "defenceFare"}
                onChange={() =>
                  setTripType(
                    tripType === "defenceFare" ? "roundTrip" : "defenceFare"
                  )
                }
              />
              <label htmlFor="defenceFare">Defence Fare</label>
            </div>
          </div>
          ...
          <div className="col-auto">
            <div className="text-center" style={{ marginTop: "-100px" }}>
              ...
              <p
                ...
                data-aos-delay="100"
              >
                Flight booking made faster and efficent
              </p>
            </div>
